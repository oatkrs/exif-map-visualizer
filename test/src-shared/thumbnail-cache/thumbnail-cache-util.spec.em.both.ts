...
describe('ThumbnailCacheUtil', () => {
  describe('getThumbnailFilePath should return the thumbnail file path from the original file path', () => {
    ...
    if (os.platform() === 'win32') {
      const testCases = [
        {
          originalFilePath: 'C:\\Users\\Utkarsh\\Desktop\\IMG_100.HEIC',
          expectedThumbnailFileDir: `${plmThumbnailCacheDir}\\D_C\\Users\\Utkarsh\\Desktop`,
          expectedThumbnailFilePath: `${plmThumbnailCacheDir}\\D_C\\Users\\Utkarsh\\Desktop\\IMG_100.HEIC.plm.jpg`
        },
        {
    ...
    if (os.platform() === 'darwin' || os.platform() === 'linux') {
      it('on macOS or Linux', () => {
        const testCases = [
          {
            originalFilePath: '/Users/Utkarsh/Desktop/IMG_100.HEIC',
            expectedThumbnailFileDir: `${plmThumbnailCacheDir}/Users/Utkarsh/Desktop`,
            expectedThumbnailFilePath: `${plmThumbnailCacheDir}/Users/Utkarsh/Desktop/IMG_100.HEIC.plm.jpg`
          },
          {
  ...
  describe('getThumbnailLogFilePath should return the thumbnail log file path from the original file path', () => {
    ...
    if (os.platform() === 'win32') {
      const testCases = [
        {
          originalFilePath: 'C:\\Users\\Utkarsh\\Desktop\\IMG_100.HEIC',
          expectedThumbnailLogFilePath: `${plmThumbnailCacheDir}\\D_C\\Users\\Utkarsh\\Desktop\\IMG_100.HEIC.log.json`
        },
        {
          originalFilePath: '\\\\Hostname\\Folder\\IMG_100.HEIC',
    ...
    if (os.platform() === 'darwin' || os.platform() === 'linux') {
      const testCases = [
        {
          originalFilePath: '/Users/Utkarsh/Desktop/IMG_100.HEIC',
          expectedThumbnailLogFilePath: `${plmThumbnailCacheDir}/Users/Utkarsh/Desktop/IMG_100.HEIC.log.json`
        },
        {
          originalFilePath: '/Volumes/VolumeName/Folder/IMG_100.HEIC',
  ...
  describe('getOriginalFilePath should return the original file path from the thumbnail file path', () => {
    ...
    if (os.platform() === 'win32') {
      const testCases = [
        {
          thumbnailFilePath: `${plmThumbnailCacheDir}\\D_C\\Users\\Utkarsh\\Desktop\\IMG_100.HEIC.plm.jpg`,
          expectedOriginalFilePath: 'C:\\Users\\Utkarsh\\Desktop\\IMG_100.HEIC'
        },
        {
    ...
    if (os.platform() === 'darwin' || os.platform() === 'linux') {
      const testCases = [
        {
          thumbnailFilePath: `${plmThumbnailCacheDir}/Users/Utkarsh/Desktop/IMG_100.HEIC.plm.jpg`,
          expectedOriginalFilePath: '/Users/Utkarsh/Desktop/IMG_100.HEIC'
        },
        {
